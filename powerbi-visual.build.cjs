...
write('package.json',{name:'regulatory-timeline-powerbi',version:'1.5.0',private:true,scripts:{package:'pbiviz package',test:'node test.cjs'},dependencies:{'powerbi-visuals-api':'5.11.0','vega':'5.33.0','vega-interpreter':'1.2.1'},devDependencies:{'powerbi-visuals-tools':'7.2.1','typescript':'5.9.3','@playwright/test':'1.55.1','esbuild':'0.25.10'}});
write('pbiviz.json',{visual:{name:'regulatoryTimeline',displayName:'Regulatory Tracker',guid:'regulatoryTimelineA2C514A9F58240B5A313F650E136F4F0',visualClassName:'Visual',version:'1.5.0.0',description:'The regulatory lifecycle demo as a self-contained Power BI visual. Hierarchy, searchable filters, comparison and full details.',supportUrl:'https://github.com/DangerMitch2000/regulatory-timeline-demo/issues',gitHubUrl:'https://github.com/DangerMitch2000/regulatory-timeline-demo'},apiVersion:'5.11.0',author:{name:'Dualta Mitchell',email:'dualtamitchell@gmail.com'},assets:{icon:'assets/icon.png'},externalJS:null,style:'style/visual.less',capabilities:'capabilities.json',dependencies:null,stringResources:[]});
...
html=html.replace('VERSION 1.5 · FICTIONAL DATA','POWER BI · 1.5 PREVIEW').replace('<small>1.5</small>','<small>1.5</small>').replace('All examples are fictional. ','').replace(/<a href="https:\/\/github.com[\s\S]*?<\/a>/,'');
